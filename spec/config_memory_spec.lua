...
describe("set and get values", function()
    ...
    it("custom storage purely contain what is set", function()
        local conf = config{storage={}}
        conf.set("foo.bar", "value")
        assert.are.same({ ["foo.bar"] = "value" }, conf.storage)
    end)
    it("set preserves type", function()
        local conf = config()
        conf.set("foo.bar", "value")
    ...
    it("support reference statements $(x.y.z)", function()
        local conf = config()
        conf.set("foo.bar", "value")
...
describe("enumerate", function()
    ...
    it("keys dispite prefix", function()
